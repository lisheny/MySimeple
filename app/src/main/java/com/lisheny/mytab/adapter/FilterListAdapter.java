...
public class FilterListAdapter extends RecyclerView.Adapter<FilterListAdapter.MyViewHolder> {
    ...
    public FilterListAdapter(Context context, List<FilterListBeen.FiltersBean> datas) {
        this.mDatas = datas;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.tvSound.setBackgroundResource(R.drawable.home_shape_bg_filter);
        holder.tvSound.setText(filtersBean.getFiltername());
